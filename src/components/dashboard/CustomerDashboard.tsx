    ...
    switch (activeSection) {
                ...
                <GlassCard variant="default" className="p-3 sm:p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="text-xl sm:text-2xl font-bold">{stats.upcomingBookings}</p>
            ...
            <FadeIn delay={0.4}>
              <GlassCard variant="default" className="p-4 sm:p-6">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-sm sm:text-base font-semibold">Upcoming Appointments</h3>
                  <button 
                ...
                <div className="space-y-3">
                  {bookings.filter(b => b.status === 'CONFIRMED' || b.status === 'PENDING').slice(0, 3).map(booking => (
                    <div key={booking.id} className="flex items-center gap-3 sm:gap-4 p-3 rounded-lg bg-muted/30">
                      <img 
      ...
      case 'payments':
        return (
          <div className="space-y-4">
            <GlassCard variant="default" className="p-4 sm:p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm sm:text-base font-semibold">Payment Methods</h3>
            ...
            <GlassCard variant="default" className="p-4 sm:p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm sm:text-base font-semibold">Payment History</h3>
            ...
            <GlassCard variant="default" className="p-4 sm:p-6">
              <h3 className="text-sm sm:text-base font-semibold mb-4">Spending Overview</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      ...
      case 'settings':
        return (
          <div className="space-y-6">
            <GlassCard variant="default" className="p-4 sm:p-6">
              <h3 className="text-sm sm:text-base font-semibold mb-4">Profile Settings</h3>
              <div className="space-y-4">
                <div>
            ...
            <GlassCard variant="default" className="p-4 sm:p-6">
              <h3 className="text-sm sm:text-base font-semibold mb-4">Notification Preferences</h3>
              <div className="space-y-4">
                {[
            ...
            {!hasProviderRole && !isAdmin && !user?.businessVerificationStatus && (
              <GlassCard variant="elevated" className="p-4 sm:p-6 border-primary/30">
                <div className="flex items-start gap-4">
